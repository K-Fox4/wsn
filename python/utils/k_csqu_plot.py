...
def plot_lambda_vs_k_for_sq_vs_tr_hx(sensing_radius: int = 25) -> None:
    ...
    hexagon_grid = SlicedHexagon(
        sensing_radius=sensing_radius,
        area_length=250
    )
    hexagon_sensor_density = []

    for i in k:
        square_sensor_density.append((square_grid.total_num_of_tiles * i) / (250 * 250))
        triangle_sensor_density.append((triangle_grid.total_num_of_tiles * i) / (250 * 250))
        hexagon_sensor_density.append((hexagon_grid.total_num_of_tiles * i) / (250 * 250))
    ...
    plt.plot(k, square_sensor_density, 'r-', marker='s', linewidth=3, markersize=12, label=r'$\it{k}$-CSqu')
    plt.plot(k, triangle_sensor_density, 'g-', marker='^', linewidth=3, markersize=12, label=r'$DIRACC_k$')
    plt.plot(k, hexagon_sensor_density, 'b-', marker='h', linewidth=3, markersize=12, label=r'$RCH_k$')
...
def plot_lambda_vs_rs_for_sq_vs_tr_hx(k: int = 3) -> None:
    ...
    for sensing_rad in sensing_radius:
        ...
        square_sensor_density.append((square_grid.total_num_of_tiles * k) / (250 * 250))
        triangle_sensor_density.append((triangle_grid.total_num_of_tiles * k) / (250 * 250))
        hexagon_sensor_density.append((hexagon_grid.total_num_of_tiles * k) / (250 * 250))
    ...
    #        xlabel=r'$\it{r_s}$',
    #        ylabel=r'Planar Sensor Density $(\lambda)$')
    plt.plot(sensing_radius, square_sensor_density, 'r-', marker='s', linewidth=3, markersize=12, label=r'$\it{k}$-CSqu')
    plt.plot(sensing_radius, triangle_sensor_density, 'g-', marker='^', linewidth=3, markersize=12, label=r'$DIRACC_k$')
    plt.plot(sensing_radius, hexagon_sensor_density, 'b-', marker='h', linewidth=3, markersize=12, label=r'$RCH_k$')
...
def plot_active_sens_vs_deployed_sens_for_sq_vs_tr_hx(sensing_radius: int = 25, k: int = 3) -> None:
    ...
    plt.plot(deployed_sensors, square_active_sensors, 'r-', linewidth=3, markersize=12, marker='s', label=r'$\it{k}$-CSqu')
    plt.plot(deployed_sensors, triangle_active_sensors, 'g-', linewidth=3, markersize=12, marker='^', label=r'$DIRACC_k$')
    plt.plot(deployed_sensors, hexagon_active_sensors, 'b-', marker='h', linewidth=3, markersize=12, label=r'$RCH_k$')
...
def plot_active_sensors_vs_k_for_sq_vs_tr_hx(sensing_radius: int = 25):
    ...
    plt.plot(hexagon_active_sensors, k, 'b-', marker='h', linewidth=3, markersize=12, label=r'$RCH_k$')
...
def plot_active_sens_vs_rc_for_sq_vs_tr_hx(sensing_radius: int = 25, k: int = 3) -> None:
    ...
    square_active_sensors = [square_grid.total_num_of_tiles * k for _ in range(len(rc))]
    ...
    hexagon_active_sensors_3 = [hexagon_grid.total_num_of_tiles * 3 for _ in range(len(rc))]
    hexagon_active_sensors_4 = [hexagon_grid.total_num_of_tiles * 4 for _ in range(len(rc))]

    fig, ax = plt.subplots()

    plt.plot(rc, hexagon_active_sensors_4, 'b-', marker='h', linewidth=3, markersize=12, label=r'$RCH_k$, $\it{k}$ = 4')
    plt.plot(rc, hexagon_active_sensors_3, 'm-', marker='h', linewidth=3, markersize=12, label=r'$RCH_k$, $\it{k}$ = 3')
...
def plot_active_sens_vs_rs_for_sq_vs_tr_hx(k: int = 3) -> None:
    ...
    plt.plot(sensing_radius, hexagon_active_sensors_4, 'b-', marker='h', linewidth=3, markersize=12, label=r'$RCH_k$, $\it{k}$ = 4')
    plt.plot(sensing_radius, hexagon_active_sensors_3, 'm-', marker='h', linewidth=3, markersize=12, label=r'$RCH_k$, $\it{k}$ = 3')
...
if __name__ == "__main__":
    ...
    # plot_lambda_vs_k_for_sq_vs_tr_hx()
    # plot_lambda_vs_rs_for_sq_vs_tr_hx()
    # plot_active_sens_vs_deployed_sens_for_sq_vs_tr_hx()
    # plot_active_sensors_vs_k_for_sq_vs_tr_hx()
    # plot_active_sens_vs_rc_for_sq_vs_tr_hx()
    plot_active_sens_vs_rs_for_sq_vs_tr_hx()
