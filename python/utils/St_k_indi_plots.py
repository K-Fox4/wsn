...
def plot_lambda_vs_k() -> None:
    ...
    for k_val in k:
        ...
        planar_sensor_density_7.append((0.317 * k_val) / (sensing_radius * sensing_radius))

        sensing_radius = calculate_stochastic_rs_min(k=k_val, alpha=alpha, beta=beta, pth=0.8)
        planar_sensor_density_8.append((0.317 * k_val) / (sensing_radius * sensing_radius))

        sensing_radius = calculate_stochastic_rs_min(k=k_val, alpha=alpha, beta=beta, pth=0.9)
        planar_sensor_density_9.append((0.317 * k_val) / (sensing_radius * sensing_radius))
...
def plot_k_vs_active_sensors() -> None:
    ...
    for k_val in k:
        ...
        active_sensors_7.append(grid.total_num_of_tiles * k_val)
        ...
        active_sensors_8.append(grid.total_num_of_tiles * k_val)
        ...
        active_sensors_9.append(grid.total_num_of_tiles * k_val)
...
def plot_active_sensors_vs_beta() -> None:
    ...
    while beta <= 0.5:
        ...
        active_sensors_7.append(grid.total_num_of_tiles * k)
        ...
        active_sensors_8.append(grid.total_num_of_tiles * k)
        ...
        active_sensors_9.append(grid.total_num_of_tiles * k)
    ...
    plt.title(r'$\alpha$=2 and $\it{k}$=3', fontsize=20, fontweight='bold')
